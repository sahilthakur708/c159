...
if (id === "spider-man") {
  var spider_text = document.querySelector("#spider-man")
  spider_text.setAttribute('visible', true)
} else if (id === "super-man") {
  var super_man = document.querySelector("#super-man")
  super_man.setAttribute('visible', true)
} else if(id==="iron-man") {
  var iron_man = document.querySelector('#iron-man')
  iron_man.setAttribute('visible', true)
}
},
